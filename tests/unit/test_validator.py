...
from tests.fixtures.claim_factories import ValidClaim, UpcodingFraudClaim, PhantomBillingClaim
...
class TestClaimValidator:
    ...
    def custom_config_validator(self):
        ...
        config = {"max_daily_amount": "25000.00", "max_procedure_codes": 15}
    ...
    def test_validate_medical_claim_rules_unbundling(self, validator, medical_claim_data):
        ...
        medical_claim_data["procedure_codes"] = [
            "99213",
            "99214",
            "99215",
            "73721",
    ...
    def test_validate_pharmacy_claim_rules_excessive_days_supply(
        self, validator, pharmacy_claim_data
    ):
    ...
    def test_validate_pharmacy_claim_rules_suspicious_quantity(
        self, validator, pharmacy_claim_data
    ):
    ...
    def test_validate_no_fault_claim_rules_invalid_accident_date(
        self, validator, no_fault_claim_data
    ):
    ...
    def test_validate_data_quality_duplicates(self, validator, valid_claim_data):
        ...
        claims_data = [valid_claim_data.copy(), valid_claim_data.copy()]  # Duplicate claim
    ...
    def test_validate_batch_with_errors(self, validator):
        ...
        # Invalid claim data
        invalid_claim = {"claim_id": "INVALID", "billed_amount": "not_a_number"}
