...
class TestClaimPreprocessor:
    ...
    def test_extract_temporal_features(self, preprocessor, sample_medical_claims):
        ...
        temporal_features = [
            ...
            "date_of_service_day",
            "date_of_service_weekday",
            "date_of_service_is_weekend",
            "date_of_service_quarter",
    ...
    def test_extract_temporal_features_disabled(
        self, custom_config_preprocessor, sample_medical_claims
    ):
    ...
    def test_onehot_encode(self, preprocessor, sample_medical_claims):
        ...
        encoded_cols = [
            col for col in df.columns if "claim_type_" in col or "service_location_" in col
        ]
    ...
    def test_custom_encoding_strategy(self):
        ...
        categorical_features = [
            ...
            if col.endswith("_professional") or col.endswith("_institutional")
        ]
    ...
    def test_fitted_state_persistence(self, preprocessor, sample_medical_claims):
        ...
        assert list(df2.columns) == ["claim_id"] + preprocessor.feature_columns + [
            "fraud_indicator"
        ]
