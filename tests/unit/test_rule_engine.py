...
from tests.fixtures.claim_factories import (
    ...
    UnbundlingFraudClaim, StagedAccidentClaim, PrescriptionFraudClaim
)
...
class TestRuleEngine:
    ...
    def test_prescription_fraud_detection(self, rule_engine):
        ...
        claim = {
            ...
            'procedure_codes': ['J1100', 'J2001', 'J3420', 'J7799', 'J2315', 'J1170'],  # Many prescriptions
    ...
    def test_explanation_generation(self, rule_engine):
        ...
        results = [
            RuleResult('upcoding_complexity', True, 0.8, 'High complexity mismatch', ['Evidence 1']),
    ...
    @pytest.mark.parametrize("procedure_codes,expected", [
    ...
    def test_large_context_claims_performance(self, rule_engine, valid_claim):
        ...
        assert processing_time < BENCHMARKS.MAX_SINGLE_CLAIM_LATENCY_MS * 2  # Allow 2x for large context
        assert isinstance(results, list)
        assert isinstance(fraud_score, float)
